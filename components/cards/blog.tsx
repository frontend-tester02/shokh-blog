...
const BlogCard = (blog: Props) => {
    return (
        ...
        className={cn('grid gap-4 group', 
        blog.isVertical ? "grid-cols-1" : 
        'grid-cols-1 md:grid-cols-2')}>
            ...
            <div className="flex flex-col spcae-y-4">
                {/* Time info */}
                <Link href={`/blogs/${blog.slug}`} className="flex flex-col spcae-y-4">
